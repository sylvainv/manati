...
module.exports = function(db, logger) {
  ...
  router.get('/:table', function* fetchDataHandler() {
    this.body = yield select.query(this.table, {}, this.request.query, this.request.authorizationQuery);
  });
  ...
  router.post('/:table', function* addDataHandler() {
    ...
    this.body = yield insert.query(this.table, this.request.body, {}, this.request.authorizationQuery);
  });
  ...
  router.patch('/:table', function* updateDatahandler() {
    ...
    this.body = yield update.query(this.table, this.request.body, this.request.query, this.request.authorizationQuery);
  });

  // DELETE
  router.delete('/:table', function* deleteDataHandler() {
    this.body = yield delet.query(this.table, {}, this.request.query, this.request.authorizationQuery);
  });
